...
offretvJan = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 3000, payment_date: Date.new(2019, 1, 4), first: false)
offretvFev = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 3000, payment_date: Date.new(2019, 2, 4), first: false)
offretvMars = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 3000, payment_date: Date.new(2019, 3, 4), first: false)
offretvAvr = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 3000, payment_date: Date.new(2019, 4, 4), first: false)
offretvMai = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 3000, payment_date: Date.new(2019, 5, 4), first: false)
offretvJuin = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 3000, payment_date: Date.new(2019, 6, 4), first: false)
offretvJul = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 3000, payment_date: Date.new(2019, 7, 4), first: false)
offretvAout = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 3000, payment_date: Date.new(2019, 8, 4), first: false)
offretvSept = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 3000, payment_date: Date.new(2019, 9, 4), first: false)
offretvOct = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 3000, payment_date: Date.new(2019, 10, 4), first: false)
offretvNov = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 3000, payment_date: Date.new(2019, 11, 4), first: false)
offretvDec = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 3000, payment_date: Date.new(2019, 12, 4), first: false)
