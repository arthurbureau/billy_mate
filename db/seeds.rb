...
offretvJan = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 2500, payment_date: Date.new(2019, 1, 4), first: false)
offretvFev = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 2500, payment_date: Date.new(2019, 2, 4), first: false)
offretvMars = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 2500, payment_date: Date.new(2019, 3, 4), first: false)
offretvAvr = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 2500, payment_date: Date.new(2019, 4, 4), first: false)
offretvMai = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 2500, payment_date: Date.new(2019, 5, 4), first: false)
offretvJuin = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 2500, payment_date: Date.new(2019, 6, 4), first: false)
offretvJul = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 2500, payment_date: Date.new(2019, 7, 4), first: false)
offretvAout = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 2500, payment_date: Date.new(2019, 8, 4), first: false)
offretvSept = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 2500, payment_date: Date.new(2019, 9, 4), first: false)
offretvOct = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 2500, payment_date: Date.new(2019, 10, 4), first: false)
offretvNov = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 2500, payment_date: Date.new(2019, 11, 4), first: false)
offretvDec = Bill.create!(flat: flat1, category: 'Canal +', provider: 'Canal +', user: user2, amount_cents: 2500, payment_date: Date.new(2019, 12, 4), first: false)
...
elect_transaction6 = Transaction.create!(bill: electJuin, user: user2, amount_cents: 3000, payment_date: Date.new(2019, 6, 25))
...
gaz_transaction6 = Transaction.create!(bill: gazJuin, user: user1, amount_cents: 4500, payment_date: Date.new(2019, 6, 18))

offretv_transaction1 = Transaction.create!(bill: offretvJan, user: user1, amount_cents: 1250, payment_date: Date.new(2019, 1, 8))
offretv_transaction2 = Transaction.create!(bill: offretvFev, user: user1, amount_cents: 1250, payment_date: Date.new(2019, 2, 8))
offretv_transaction3 = Transaction.create!(bill: offretvMars, user: user1, amount_cents: 1250, payment_date: Date.new(2019, 3, 8))
offretv_transaction4 = Transaction.create!(bill: offretvAvr, user: user1, amount_cents: 1250, payment_date: Date.new(2019, 4, 8))
offretv_transaction5 = Transaction.create!(bill: offretvMai, user: user1, amount_cents: 1250, payment_date: Date.new(2019, 5, 8))
